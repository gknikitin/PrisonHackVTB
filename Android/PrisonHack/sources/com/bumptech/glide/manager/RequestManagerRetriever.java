...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private static void findAllSupportFragmentsWithViews(@Nullable Collection<android.support.p000v4.app.Fragment> collection, Map<View, android.support.p000v4.app.Fragment> map) {
        if (collection != null) {
    ...
    @Nullable
    private android.support.p000v4.app.Fragment findSupportFragment(View view, FragmentActivity fragmentActivity) {
    ...
    public SupportRequestManagerFragment getSupportRequestManagerFragment(android.support.p000v4.app.FragmentManager fragmentManager, android.support.p000v4.app.Fragment fragment) {
        ...
        fragmentManager.beginTransaction().add((android.support.p000v4.app.Fragment) supportRequestManagerFragment3, FRAGMENT_TAG).commitAllowingStateLoss();
