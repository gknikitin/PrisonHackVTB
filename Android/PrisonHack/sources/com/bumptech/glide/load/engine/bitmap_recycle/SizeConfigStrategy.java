    ...
    static /* synthetic */ class C05061 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.bumptech.glide.load.engine.bitmap_recycle.SizeConfigStrategy.C05061.<clinit>():void");
        }
    }

    private static Bitmap.Config[] getInConfigs(Bitmap.Config config) {
        switch (C05061.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()]) {
            case 1:
