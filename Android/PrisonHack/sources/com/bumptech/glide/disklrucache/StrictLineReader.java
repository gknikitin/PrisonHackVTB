...
class StrictLineReader implements Closeable {
    ...
    /* renamed from: CR */
    private static final byte f38CR = 13;

    /* renamed from: LF */
    private static final byte f39LF = 10;
    private byte[] buf;
    ...
    /* renamed from: in */
    private final InputStream f40in;
    private int pos;
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f40in) {
            ...
            C04941 r1 = new ByteArrayOutputStream((this.end - this.pos) + 80) {
    ...
    private void fillBuf() throws IOException {
        int read = this.f40in.read(this.buf, 0, this.buf.length);
        if (read == -1) {
