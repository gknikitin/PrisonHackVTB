...
public abstract class BaseDrawerItem<T, VH extends RecyclerView.ViewHolder> extends AbstractDrawerItem<T, VH> implements Nameable<T>, Iconable<T>, Tagable<T>, Typefaceable<T> {
    ...
    public int getSelectedColor(Context context) {
        return ColorHolder.color(getSelectedColor(), context, C0658R.attr.material_drawer_selected, C0658R.C0659color.material_drawer_selected);
    }
    ...
    public int getIconColor(Context context) {
        if (isEnabled()) {
            return ColorHolder.color(getIconColor(), context, C0658R.attr.material_drawer_primary_icon, C0658R.C0659color.material_drawer_primary_icon);
        }
        return ColorHolder.color(getDisabledIconColor(), context, C0658R.attr.material_drawer_hint_icon, C0658R.C0659color.material_drawer_hint_icon);
    }

    /* access modifiers changed from: protected */
    public int getSelectedIconColor(Context context) {
        return ColorHolder.color(getSelectedIconColor(), context, C0658R.attr.material_drawer_selected_text, C0658R.C0659color.material_drawer_selected_text);
    }
