...
public class AccountHeader {
    ...
    public void setHeaderBackground(ImageHolder imageHolder) {
        ImageHolder.applyTo((com.mikepenz.materialize.holder.ImageHolder) imageHolder, this.mAccountHeaderBuilder.mAccountHeaderBackground);
    }
    ...
    public void setActiveProfile(IProfile iProfile, boolean z) {
        ...
        if (z && this.mAccountHeaderBuilder.mOnAccountHeaderListener != null) {
            this.mAccountHeaderBuilder.mOnAccountHeaderListener.onProfileChanged((View) null, iProfile, switchProfiles);
        }
    }
    ...
    public void setActiveProfile(long j, boolean z) {
        if (this.mAccountHeaderBuilder.mProfiles != null) {
            for (IProfile next : this.mAccountHeaderBuilder.mProfiles) {
    ...
    private int getPositionByIdentifier(long j) {
        if (!(this.mAccountHeaderBuilder.mProfiles == null || j == -1)) {
            for (int i = 0; i < this.mAccountHeaderBuilder.mProfiles.size(); i++) {
                if (this.mAccountHeaderBuilder.mProfiles.get(i) != null && this.mAccountHeaderBuilder.mProfiles.get(i).getIdentifier() == j) {
                    return i;
                }
            }
        }
