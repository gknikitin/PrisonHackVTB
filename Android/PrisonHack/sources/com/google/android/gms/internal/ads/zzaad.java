...
public final class zzaad {
    ...
    public final void execute() {
        if (this.zzbnd == null) {
            ...
            this.zzbnd.setRequestedOrientation("portrait".equalsIgnoreCase(this.zzbwn) ? zzbv.zzem().zzrm() : "landscape".equalsIgnoreCase(this.zzbwn) ? zzbv.zzem().zzrl() : this.zzbwm ? -1 : zzbv.zzem().zzrn());
        }
    }
}
