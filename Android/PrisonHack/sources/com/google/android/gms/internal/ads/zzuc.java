...
final class zzuc {
    ...
    public final String zzlu() {
        Parcel obtain = Parcel.obtain();
        try {
            String encodeToString = Base64.encodeToString(this.zzye.getBytes(Key.STRING_CHARSET_NAME), 0);
            ...
            zzakb.m40e("QueueSeed encode failed because UTF-8 is not available.");
            obtain.recycle();
            return "";
        } catch (Throwable th) {
            obtain.recycle();
