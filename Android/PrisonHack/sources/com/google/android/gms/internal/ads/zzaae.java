...
public final class zzaae extends zzaal {
    ...
    public final void execute() {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            zzan.setTitle(resources != null ? resources.getString(C0577R.string.f69s1) : "Save image");
            zzan.setMessage(resources != null ? resources.getString(C0577R.string.f70s2) : "Allow Ad to store image in Picture gallery?");
            zzan.setPositiveButton(resources != null ? resources.getString(C0577R.string.f71s3) : "Accept", new zzaaf(this, str, lastPathSegment));
            zzan.setNegativeButton(resources != null ? resources.getString(C0577R.string.f72s4) : "Decline", new zzaag(this));
            zzan.create().show();
        }
    }
}
