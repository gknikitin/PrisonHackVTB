...
final class zzari extends WebView implements ViewTreeObserver.OnGlobalLayoutListener, DownloadListener, zzaqw {
    ...
    public final synchronized void destroy() {
        ...
        if (!this.zzddj) {
            ...
            zzvn();
            this.zzddj = true;
            zzakb.m39v("Initiating WebView self destruct sequence in 3...");
            zzakb.m39v("Loading blank page in WebView, 2...");
            zzdt("about:blank");
        }
    }
    ...
    public final synchronized void onMeasure(int r8, int r9) {
        ...
        L_0x008e:
            ...
            r7.zza((java.lang.String) r0, (com.google.android.gms.ads.internal.gmsg.zzv<? super com.google.android.gms.internal.ads.zzaqw>) r1)     // Catch:{ all -> 0x01db }
        ...
        L_0x01a1:
            ...
            r8.zza((com.google.android.gms.internal.ads.zzhu.zza.zzb) r9)     // Catch:{ all -> 0x01db }
    ...
    public final synchronized void zza(zzarl zzarl) {
        if (this.zzddp != null) {
            zzakb.m40e("Attempt to create multiple AdWebViewVideoControllers.");
        } else {
            this.zzddp = zzarl;
        }
    }
    ...
    public final synchronized void zzc(String str, String str2, @Nullable String str3) {
        if (!isDestroyed()) {
            ...
            super.loadDataWithBaseURL(str, str2, "text/html", Key.STRING_CHARSET_NAME, str3);
            return;
        }
        zzakb.zzdk("#004 The webview is destroyed. Ignoring action.");
    }
    ...
    public final void zzus() {
        zzakb.m39v("Cannot add text view to inner AdWebView");
    }
}
