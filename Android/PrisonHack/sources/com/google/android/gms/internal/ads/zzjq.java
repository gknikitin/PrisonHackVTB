...
import com.google.android.gms.ads.C0576R;
...
public final class zzjq {
    ...
    public zzjq(Context context, AttributeSet attributeSet) {
        AdSize[] zzab;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C0576R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C0576R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C0576R.styleable.AdsAttrs_adSizes);
        ...
        this.zzarh = zzab;
        this.zzye = obtainAttributes.getString(C0576R.styleable.AdsAttrs_adUnitId);
