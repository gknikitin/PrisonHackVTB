...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", mo13061id = 2)
    private final int zzam;
    @SafeParcelable.Field(getter = "getResolution", mo13061id = 3)
    private final PendingIntent zzan;
    @SafeParcelable.Field(getter = "getErrorMessage", mo13061id = 4)
    ...
    ConnectionResult(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) int i2, @SafeParcelable.Param(mo13064id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(mo13064id = 4) String str) {
        this.zzal = i;
        this.zzam = i2;
    ...
    public final String toString() {
        return Objects.toStringHelper(this).add("statusCode", zza(this.zzam)).add("resolution", this.zzan).add(AppConstant.BUNDLE_KEY_MESSAGE, this.zzao).toString();
    }
