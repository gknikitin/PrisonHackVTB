...
public final class GmsLogger {
    ...
    /* renamed from: d */
    public final void mo12970d(String str, String str2) {
        if (canLog(3)) {
            Log.d(str, zzl(str2));
        }
    }
    ...
    /* renamed from: d */
    public final void mo12971d(String str, String str2, Throwable th) {
        if (canLog(3)) {
    ...
    /* renamed from: e */
    public final void mo12973e(String str, String str2) {
        if (canLog(6)) {
            Log.e(str, zzl(str2));
        }
    }
    ...
    /* renamed from: e */
    public final void mo12974e(String str, String str2, Throwable th) {
        if (canLog(6)) {
    ...
    /* renamed from: i */
    public final void mo12977i(String str, String str2) {
        if (canLog(4)) {
            Log.i(str, zzl(str2));
        }
    }
    ...
    /* renamed from: i */
    public final void mo12978i(String str, String str2, Throwable th) {
        if (canLog(4)) {
    ...
    /* renamed from: v */
    public final void mo12983v(String str, String str2) {
        if (canLog(2)) {
            Log.v(str, zzl(str2));
        }
    }
    ...
    /* renamed from: v */
    public final void mo12984v(String str, String str2, Throwable th) {
        if (canLog(2)) {
    ...
    /* renamed from: w */
    public final void mo12986w(String str, String str2) {
        if (canLog(5)) {
            Log.w(str, zzl(str2));
        }
    }
    ...
    /* renamed from: w */
    public final void mo12987w(String str, String str2, Throwable th) {
        if (canLog(5)) {
