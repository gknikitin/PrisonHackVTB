...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @SafeParcelable.VersionField(mo13067id = 1000)
    private final int zzal;
    @SafeParcelable.Field(getter = "getStatusCode", mo13061id = 3)
    private final int zzam;
    @SafeParcelable.Field(getter = "getColumns", mo13061id = 1)
    private final String[] zznm;
    private Bundle zznn;
    @SafeParcelable.Field(getter = "getWindows", mo13061id = 2)
    private final CursorWindow[] zzno;
    @SafeParcelable.Field(getter = "getMetadata", mo13061id = 4)
    ...
    DataHolder(@SafeParcelable.Param(mo13064id = 1000) int i, @SafeParcelable.Param(mo13064id = 1) String[] strArr, @SafeParcelable.Param(mo13064id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(mo13064id = 3) int i2, @SafeParcelable.Param(mo13064id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zzns = true;
        this.zzal = i;
        this.zznm = strArr;
