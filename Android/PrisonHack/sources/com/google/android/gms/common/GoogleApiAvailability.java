        ...
        if (i == 18) {
            ...
            if (DeviceProperties.isWearable(context)) {
                ...
                if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                    style.addAction(C0580R.C0582drawable.common_full_open_on_phone, resources.getString(C0580R.string.common_open_on_phone), pendingIntent);
                } else {
