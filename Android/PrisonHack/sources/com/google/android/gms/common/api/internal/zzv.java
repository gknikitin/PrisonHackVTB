...
public final class zzv<O extends Api.ApiOptions> extends GoogleApi<O> {
    ...
    public zzv(@NonNull Context context, Api<O> api, Looper looper, @NonNull Api.Client client, @NonNull zzp zzp, ClientSettings clientSettings, Api.AbstractClientBuilder<? extends SignInClient, SignInOptions> abstractClientBuilder) {
