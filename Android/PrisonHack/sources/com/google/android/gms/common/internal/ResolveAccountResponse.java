...
public class ResolveAccountResponse extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getConnectionResult", mo13061id = 3)
    private ConnectionResult zzeu;
    @SafeParcelable.Field(getter = "getSaveDefaultAccount", mo13061id = 4)
    private boolean zzhs;
    @SafeParcelable.Field(mo13061id = 2)
    private IBinder zzqv;
    @SafeParcelable.Field(getter = "isFromCrossClientAuth", mo13061id = 5)
    ...
    ResolveAccountResponse(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) IBinder iBinder, @SafeParcelable.Param(mo13064id = 3) ConnectionResult connectionResult, @SafeParcelable.Param(mo13064id = 4) boolean z, @SafeParcelable.Param(mo13064id = 5) boolean z2) {
        this.zzal = i;
        this.zzqv = iBinder;
