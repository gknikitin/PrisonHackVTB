...
public final class ConnectionEvent extends StatsEvent {
    ...
    @SafeParcelable.Field(getter = "getEventType", mo13061id = 12)
    private int zzxw;
    @SafeParcelable.Field(getter = "getCallingProcess", mo13061id = 4)
    private final String zzxx;
    @SafeParcelable.Field(getter = "getCallingService", mo13061id = 5)
    private final String zzxy;
    @SafeParcelable.Field(getter = "getTargetProcess", mo13061id = 6)
    private final String zzxz;
    @SafeParcelable.Field(getter = "getTargetService", mo13061id = 7)
    private final String zzya;
    @SafeParcelable.Field(getter = "getStackTrace", mo13061id = 8)
    private final String zzyb;
    @SafeParcelable.Field(getter = "getEventKey", mo13061id = 13)
    private final String zzyc;
    @SafeParcelable.Field(getter = "getElapsedRealtime", mo13061id = 10)
    private final long zzyd;
    @SafeParcelable.Field(getter = "getHeapAlloc", mo13061id = 11)
    private final long zzye;
    private long zzyf;

    @SafeParcelable.Constructor
    ConnectionEvent(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) long j, @SafeParcelable.Param(mo13064id = 12) int i2, @SafeParcelable.Param(mo13064id = 4) String str, @SafeParcelable.Param(mo13064id = 5) String str2, @SafeParcelable.Param(mo13064id = 6) String str3, @SafeParcelable.Param(mo13064id = 7) String str4, @SafeParcelable.Param(mo13064id = 8) String str5, @SafeParcelable.Param(mo13064id = 13) String str6, @SafeParcelable.Param(mo13064id = 10) long j2, @SafeParcelable.Param(mo13064id = 11) long j3) {
        this.zzal = i;
        this.zzxv = j;
        this.zzxw = i2;
        this.zzxx = str;
