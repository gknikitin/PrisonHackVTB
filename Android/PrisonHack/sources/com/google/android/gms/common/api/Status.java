...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getStatusCode", mo13061id = 1)
    private final int zzam;
    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", mo13061id = 3)
    private final PendingIntent zzan;
    @Nullable
    @SafeParcelable.Field(getter = "getStatusMessage", mo13061id = 2)
    ...
    @KeepForSdk
    Status(@SafeParcelable.Param(mo13064id = 1000) int i, @SafeParcelable.Param(mo13064id = 1) int i2, @Nullable @SafeParcelable.Param(mo13064id = 2) String str, @Nullable @SafeParcelable.Param(mo13064id = 3) PendingIntent pendingIntent) {
        this.zzal = i;
        this.zzam = i2;
        this.zzao = str;
