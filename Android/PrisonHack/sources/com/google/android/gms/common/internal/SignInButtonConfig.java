...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getScopes", mo13061id = 4)
    @Deprecated
    private final Scope[] zzqw;
    @SafeParcelable.Field(getter = "getButtonSize", mo13061id = 2)
    private final int zzux;
    @SafeParcelable.Field(getter = "getColorScheme", mo13061id = 3)
    private final int zzuy;

    @SafeParcelable.Constructor
    SignInButtonConfig(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) int i2, @SafeParcelable.Param(mo13064id = 3) int i3, @SafeParcelable.Param(mo13064id = 4) Scope[] scopeArr) {
        this.zzal = i;
        this.zzux = i2;
        this.zzuy = i3;
        this.zzqw = scopeArr;
