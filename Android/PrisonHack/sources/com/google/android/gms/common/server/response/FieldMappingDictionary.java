...
public class FieldMappingDictionary extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getSerializedDictionary", mo13061id = 2)
    private final ArrayList<Entry> zzxl;
    @SafeParcelable.Field(getter = "getRootClassName", mo13061id = 3)
    ...
    public static class Entry extends AbstractSafeParcelable {
        ...
        Entry(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) String str, @SafeParcelable.Param(mo13064id = 3) ArrayList<FieldMapPair> arrayList) {
            this.versionCode = i;
            this.className = str;
            this.zzxn = arrayList;
        }
    ...
    public static class FieldMapPair extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Constructor
        FieldMapPair(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) String str, @SafeParcelable.Param(mo13064id = 3) FastJsonResponse.Field<?, ?> field) {
            this.versionCode = i;
            this.zzxo = str;
            this.zzxp = field;
        }
    ...
    @SafeParcelable.Constructor
    FieldMappingDictionary(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) ArrayList<Entry> arrayList, @SafeParcelable.Param(mo13064id = 3) String str) {
        this.zzal = i;
        this.zzxl = null;
