...
public class ConverterWrapper extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getStringToIntConverter", mo13061id = 2)
    private final StringToIntConverter zzwd;

    @SafeParcelable.Constructor
    ConverterWrapper(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) StringToIntConverter stringToIntConverter) {
        this.zzal = i;
