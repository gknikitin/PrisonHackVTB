...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getWidth", mo13061id = 3)
    private final int zzps;
    @SafeParcelable.Field(getter = "getHeight", mo13061id = 4)
    private final int zzpt;
    @SafeParcelable.Field(getter = "getUrl", mo13061id = 2)
    private final Uri zzpu;

    @SafeParcelable.Constructor
    WebImage(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) Uri uri, @SafeParcelable.Param(mo13064id = 3) int i2, @SafeParcelable.Param(mo13064id = 4) int i3) {
        this.zzal = i;
        this.zzpu = uri;
        this.zzps = i2;
        this.zzpt = i3;
