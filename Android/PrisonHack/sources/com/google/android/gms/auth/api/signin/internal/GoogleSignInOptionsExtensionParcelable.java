...
public class GoogleSignInOptionsExtensionParcelable extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getBundle", mo13061id = 3)
    private Bundle mBundle;
    @SafeParcelable.VersionField(mo13067id = 1)
    private final int versionCode;
    @SafeParcelable.Field(getter = "getType", mo13061id = 2)
    private int zzac;

    @SafeParcelable.Constructor
    GoogleSignInOptionsExtensionParcelable(@SafeParcelable.Param(mo13064id = 1) int i, @GoogleSignInOptionsExtension.TypeId @SafeParcelable.Param(mo13064id = 2) int i2, @SafeParcelable.Param(mo13064id = 3) Bundle bundle) {
        this.versionCode = i;
        this.zzac = i2;
        this.mBundle = bundle;
    }
