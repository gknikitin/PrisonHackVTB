...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    @SafeParcelable.Field(getter = "getScopes", mo13061id = 2)
    public final ArrayList<Scope> zzr;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getAccount", mo13061id = 3)
    public Account zzs;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isIdTokenRequested", mo13061id = 4)
    public boolean zzt;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", mo13061id = 5)
    public final boolean zzu;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", mo13061id = 6)
    public final boolean zzv;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getServerClientId", mo13061id = 7)
    public String zzw;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getHostedDomain", mo13061id = 8)
    public String zzx;
    /* access modifiers changed from: private */
    @SafeParcelable.Field(getter = "getExtensions", mo13061id = 9)
