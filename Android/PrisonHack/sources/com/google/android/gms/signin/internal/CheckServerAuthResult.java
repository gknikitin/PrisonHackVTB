...
public class CheckServerAuthResult extends AbstractSafeParcelable {
    ...
    CheckServerAuthResult(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) boolean z, @SafeParcelable.Param(mo13064id = 3) List<Scope> list) {
        this.zzal = i;
        this.zzadp = z;
        this.zzadq = list;
    }
