...
public class SignInRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getResolveAccountRequest", mo13061id = 2)
    private final ResolveAccountRequest zzadt;
    @SafeParcelable.VersionField(mo13067id = 1)
    private final int zzal;

    @SafeParcelable.Constructor
    SignInRequest(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) ResolveAccountRequest resolveAccountRequest) {
        this.zzal = i;
