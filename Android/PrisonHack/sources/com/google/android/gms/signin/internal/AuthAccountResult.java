...
public class AuthAccountResult extends AbstractSafeParcelable implements Result {
    ...
    @SafeParcelable.Field(getter = "getConnectionResultCode", mo13061id = 2)
    private int zzadn;
    @SafeParcelable.Field(getter = "getRawAuthResolutionIntent", mo13061id = 3)
    ...
    AuthAccountResult(@SafeParcelable.Param(mo13064id = 1) int i, @SafeParcelable.Param(mo13064id = 2) int i2, @SafeParcelable.Param(mo13064id = 3) Intent intent) {
        this.zzal = i;
        this.zzadn = i2;
        this.zzado = intent;
    }
