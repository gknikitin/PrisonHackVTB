    ...
    private static class EasingFunctions {
        ...
        public static final EasingFunction EaseInElastic = new EasingFunction() {
            public float getInterpolation(float f) {
                ...
                float f2 = f - 1.0f;
                return -(((float) Math.pow(2.0d, (double) (10.0f * f2))) * ((float) Math.sin((((double) (f2 - (0.047746483f * ((float) Math.asin(1.0d))))) * 6.283185307179586d) / ((double) 0.3f))));
            }
        };
        ...
        public static final EasingFunction EaseInOutElastic = new EasingFunction() {
            public float getInterpolation(float f) {
                ...
                if (f2 < 1.0f) {
                    float f3 = f2 - 1.0f;
                    return ((float) Math.pow(2.0d, (double) (10.0f * f3))) * ((float) Math.sin((((double) ((f3 * 1.0f) - asin)) * 6.283185307179586d) / ((double) 0.45000002f))) * -0.5f;
                }
                float f4 = f2 - 1.0f;
                return (((float) Math.pow(2.0d, (double) (-10.0f * f4))) * ((float) Math.sin((((double) ((f4 * 1.0f) - asin)) * 6.283185307179586d) / ((double) 0.45000002f))) * 0.5f) + 1.0f;
            }
        };
