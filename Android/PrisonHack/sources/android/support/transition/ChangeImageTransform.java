    ...
    static /* synthetic */ class C01393 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.transition.ChangeImageTransform.C01393.<clinit>():void");
        }
    }

    private static Matrix copyImageMatrix(ImageView imageView) {
        switch (C01393.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()]) {
            case 1:
