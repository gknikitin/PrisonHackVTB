...
public class BottomNavigationItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public BottomNavigationItemView(Context context, AttributeSet attributeSet, int i) {
        ...
        int dimensionPixelSize = resources.getDimensionPixelSize(C0046R.dimen.design_bottom_navigation_text_size);
        int dimensionPixelSize2 = resources.getDimensionPixelSize(C0046R.dimen.design_bottom_navigation_active_text_size);
        this.mDefaultMargin = resources.getDimensionPixelSize(C0046R.dimen.design_bottom_navigation_margin);
        ...
        LayoutInflater.from(context).inflate(C0046R.layout.design_bottom_navigation_item, this, true);
        setBackgroundResource(C0046R.C0048drawable.design_bottom_navigation_item_background);
        this.mIcon = (ImageView) findViewById(C0046R.C0049id.icon);
        this.mSmallLabel = (TextView) findViewById(C0046R.C0049id.smallLabel);
        this.mLargeLabel = (TextView) findViewById(C0046R.C0049id.largeLabel);
    }
