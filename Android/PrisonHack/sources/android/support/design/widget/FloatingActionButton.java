...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0046R.styleable.FloatingActionButton, i, C0046R.style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = obtainStyledAttributes.getColorStateList(C0046R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = ViewUtils.parseTintMode(obtainStyledAttributes.getInt(C0046R.styleable.FloatingActionButton_backgroundTintMode, -1), (PorterDuff.Mode) null);
        this.mRippleColor = obtainStyledAttributes.getColor(C0046R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = obtainStyledAttributes.getInt(C0046R.styleable.FloatingActionButton_fabSize, -1);
        this.mCustomSize = obtainStyledAttributes.getDimensionPixelSize(C0046R.styleable.FloatingActionButton_fabCustomSize, 0);
        this.mBorderWidth = obtainStyledAttributes.getDimensionPixelSize(C0046R.styleable.FloatingActionButton_borderWidth, 0);
        float dimension = obtainStyledAttributes.getDimension(C0046R.styleable.FloatingActionButton_elevation, 0.0f);
        float dimension2 = obtainStyledAttributes.getDimension(C0046R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.mCompatPadding = obtainStyledAttributes.getBoolean(C0046R.styleable.FloatingActionButton_useCompatPadding, false);
        obtainStyledAttributes.recycle();
        this.mImageHelper = new AppCompatImageHelper(this);
        this.mImageHelper.loadFromAttributes(attributeSet, i);
        this.mMaxImageSize = (int) getResources().getDimension(C0046R.dimen.design_fab_image_size);
    ...
    private int getSizeDimension(int i) {
        ...
        if (i != -1) {
            if (i != 1) {
                return resources.getDimensionPixelSize(C0046R.dimen.design_fab_size_normal);
            }
            return resources.getDimensionPixelSize(C0046R.dimen.design_fab_size_mini);
    ...
    public static class Behavior extends CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0046R.styleable.FloatingActionButton_Behavior_Layout);
            this.mAutoHideEnabled = obtainStyledAttributes.getBoolean(C0046R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, AUTO_HIDE_DEFAULT);
            obtainStyledAttributes.recycle();
        }
