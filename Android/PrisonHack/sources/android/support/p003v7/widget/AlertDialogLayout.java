    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0372R.C0375id.topPanel) {
                    view = childAt;
                } else if (id == C0372R.C0375id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0372R.C0375id.contentPanel && id != C0372R.C0375id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            ...
            view2.measure(i8, View.MeasureSpec.makeMeasureSpec(i5, CrashUtils.ErrorDialogData.SUPPRESSED));
