...
class DropDownListView extends ListView {
    ...
    DropDownListView(Context context, boolean z) {
        super(context, (AttributeSet) null, C0372R.attr.dropDownListViewStyle);
        this.mHijackFocus = z;
        setCacheColorHint(0);
        try {
    ...
    public int measureHeightOfChildrenCompat(int i, int i2, int i3, int i4, int i5) {
        ...
        while (i9 < count) {
            ...
            if (layoutParams.height > 0) {
                i6 = View.MeasureSpec.makeMeasureSpec(layoutParams.height, CrashUtils.ErrorDialogData.SUPPRESSED);
            } else {
